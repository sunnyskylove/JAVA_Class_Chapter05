...
public class Application01 {
    public static void main(String[] args) {
        ...
        *   1. 얕은 복사(shallow copy) : stack 에 주소값만 복사(변수에 담겨있는 주소만 복사했다.)
        ...
        * */
        ...
        // 원본 배열 생성
        int[] originArr = {1,2,3,4,5,10};

        // originArr 에 저장된 배열의 주소를 copyArr 에도 저장해보자.
        int[] copyArr = originArr;              // 얕은 복사

        System.out.println(originArr.hashCode());     //hashcode() 는 그냥 우리의 주민번호 처럼 생각하자!(고유한 번호를 반환해주는 메소드)
        System.out.println(copyArr.hashCode());
        // 얕은복사를 했기 때문에 복제했을시 hashcode 가 같은 것이다!!
        ...
        for(int i = 0; i < copyArr.length; i++){
            ...
            // * 결론: 원본의 값을 변경하면 copy한 값도 동시에 변경된다.
        }

        System.out.println("====================copy 변경================================");
        copyArr[0] = 99;
        ...
        for(int i = 0; i < copyArr.length; i++){
            ...
            // * 결론: copyArr를 변경해도 originArr 도 함께 변경됨
